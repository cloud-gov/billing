...
func (s *stubQuerier) CreateCustomer(_ context.Context, arg db.CreateCustomerParams) (db.Customer, error) {
	panic("unimplemented")
}
...
func (s *stubQuerier) UpdateResourceKind(_ context.Context, arg db.UpdateResourceKindParams) error {
	panic("unimplemented")
}
...
func TestRecordReading(t *testing.T) {
	...
	for _, tc := range cases {
		t.Run(tc.name, func(t *testing.T) {
			...
			err := recorder.RecordReading(t.Context(), nullLogger, stub, tc.reading)
