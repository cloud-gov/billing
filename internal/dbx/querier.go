// dbx extends the [db] package with application-specific database code. The contents of the [db] package are generated by sqlc and regularly overwritten, making it unsuitable for custom code.
package dbx
